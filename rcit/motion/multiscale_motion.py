...
import numpy as np
from rcit.util.pre_process.pre_process import timer
from rcit.util.pre_process.pre_process import get_pyramids
from rcit.util.bbme import get_motion_field
import itertools
...
def best_affine_parameters_robust(previous, current, old_parameters):
    ...
    old_params_motion_field = get_motion_field_affine(
        gt_motion_field.shape, old_parameters
    )
