...
def get_child_rain_cell(time_step,
    ...
    for i1 in range(time_step):
        ...
        for i2 in range(rows):
            ...
            if boundary_box_next_time is not None:
                ...
                for i3 in range(rows_1):
                    ...
                    if (
                        ...
                        candidate_child_cell_coords[i3] = np.zeros([len(coords_next_time[i3]), 2], dtype='float')
            ...
            candidate_child_cell_coords_1 = [i for i in candidate_child_cell_coords if np.sum(i) != 0.0]
